          ...
          <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-lg border border-gray-100 mb-16">
            ...
            <div className="mt-8 pt-8 border-t border-gray-100">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                ImageTech Industries is a trusted manufacturer of {product.name} supplying laboratories, printing, and packaging businesses in {location.name} and across {location.state}. With decades of industry expertise, our wire wound rods are built with high-grade stainless steel to provide consistent wet film thickness and reliable long-term performance.
              </p>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-lg border border-gray-100 flex flex-col h-full lg:col-span-1">
              ...
              <div className="mt-auto pt-4 border-t border-gray-100">
                ...
                <p className="text-sm text-gray-600">
                  Supplied by ImageTech Industries for testing, coating, and ink proofing applications in {location.name}, {location.state}.
                </p>
              </div>
            </div>
