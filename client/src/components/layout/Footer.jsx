        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <p className="text-sm text-gray-900 mb-6 leading-relaxed font-medium">
              We are a leading manufacturer of high-quality Bar Coaters for precision coating of substrates in laboratory, packaging, and industrial applications. Our commitment to quality, innovation, and customer satisfaction drives everything we do.
            </p>
          ...
          {/* Column 3: Our Products (Focused on Bar Coaters) */}
          <div>
            <h4 className="text-gray-900 font-bold mb-4 uppercase tracking-wide border-b-2 border-blue-500 inline-block pb-1">
              OUR PRODUCTS
            </h4>
