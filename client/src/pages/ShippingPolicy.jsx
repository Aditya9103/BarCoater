      ...
      <div className="bg-slate-50 min-h-screen py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100 prose prose-blue max-w-none text-gray-900 font-bold">
            ...
            <p className="mb-8 leading-relaxed">
              We partner with reliable and reputed logistics providers to ensure the safe and timely delivery of our precision testing products, such as Bar Coaters. Tracking information will be provided once the consignment is dispatched.
            </p>
