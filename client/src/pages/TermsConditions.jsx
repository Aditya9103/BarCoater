      ...
      <div className="bg-slate-50 min-h-screen py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100 prose prose-blue max-w-none text-gray-900 font-bold">
            ...
            <p className="mb-8 leading-relaxed">
              All industrial products, including our precision Bar Coaters, are subject to availability. We reserve the right to discontinue any products at any time for any reason. Prices for all products are subject to change without notice. We make every effort to display as accurately as possible the specifications and details of the products available on our website.
            </p>
