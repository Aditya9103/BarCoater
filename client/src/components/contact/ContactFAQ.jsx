...
const contactFaqData = [
  ...
  },
  {
    ...
    answer: "Yes, we provide comprehensive technical support. Whether you need help selecting the right Bar Coater (Mayer rod) model for a specific wet film thickness, troubleshooting a drawdown defect, or optimizing ink proofing conditions, our experts are just a phone call or email away.",
  },
  {
    question: "Can I request product samples before placing a bulk order?",
    answer:
    "Absolutely. We understand the importance of testing products in your specific environment. Contact our sales team to discuss seeing the Bar Coater in action for your laboratory specifications.",
  },
  {
