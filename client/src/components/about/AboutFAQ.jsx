...
const aboutFaqData = [
  {
    ...
    answer:
    "ImageTech Industries was established in 1992. With over three decades of experience, we have grown to become a trusted global manufacturer of Bar Coaters and testing products.",
  },
  {
  ...
  },
  {
    ...
    answer: "Our manufacturing process combines advanced CNC machining with strict, multi-stage quality inspections. This ensures every Bar Coater (wire wound rod) we produce has precise wire winding, perfect dimensional accuracy, and reliable performance required for flawless laboratory drawdowns and testing.",
  },
  {
